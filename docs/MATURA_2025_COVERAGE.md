...
`Matura2025ContentTests` wymaga kontraktu `31/35/50`, dokładnych etykiet, stron, punktacji, kluczy odpowiedzi, identyfikatorów źródeł, sum SHA-256 i dziewięciu używanych diagramów. Testy wspólnego repozytorium wymagają siedemnastu aktywnych arkuszy, 473 jednostek postępu, agregacji wszystkich zadań w 17 tematach i zachowania 35 identyfikatorów `mp21-*`.
