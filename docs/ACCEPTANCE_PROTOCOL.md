...
| ograniczenia i status prawny zasobów | `KNOWN_LIMITATIONS.md`, `CONTENT_PROVENANCE.md`, `ASSET_RIGHTS_DECLARATION.md` | PASS dla odebranego zakresu i wydania `0.9.0-beta.1`; rozszerzenie z 10 sierpnia 2026 r. zatwierdza później dodane przykłady CKE i matury 2024, dlatego bieżące `releaseEligible=true` |
...
Właściciel poświadczył posiadanie praw do zakresu zasobów ocenianego 19 lipca 2026 r., a 3, 5 i 10 sierpnia 2026 r. rozszerzył deklarację na arkusze 2024, 2025 i 2026 na obu poziomach, zasady oceniania, przykłady z informatorów CKE oraz trzydzieści jeden autorskich implementacji wektorowych Avalonia. Historyczne przekazanie prowadzącemu zostało uzgodnione i zaakceptowane, dlatego spełnia formalny wariant przekazania dla Issue #43. Manifest bieżący ma `releaseEligible=true` i wymaga przejścia obu wariantów walidatora przed każdym wydaniem.
