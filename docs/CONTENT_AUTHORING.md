...
- `Content/diagrams.json` - 77 aktywnych definicji wektorowych w schemacie 1,
...
Aktywny katalog 77 diagramów jest odtwarzany deterministycznie poleceniem:
