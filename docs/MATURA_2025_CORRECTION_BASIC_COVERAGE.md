...
Test `Matura2025CorrectionBasicContentTests` kontroluje liczniki, kolejność, strony, punkty, identyfikatory, URL-e, sumy SHA-256, metody odpowiedzi, diagramy, proweniencję i link w spisie dokumentacji. Testy katalogu i UI dodatkowo kontrolują 46 aktywnych arkuszy oraz 1 281 jednostek postępu.
