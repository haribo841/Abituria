...
| Zadania według tematów | `ZadaniaPage.xaml` oraz nowy indeks arkuszy | 17 kategorii agregujących 1 281 jednostek postępu z czterdziestu sześciu arkuszy 2015-2026 |
...
| Pełny katalog Formuły 2015 | indeks matur i dane `exam-2015-*.json`, `exam-20xx-f2015-*.json` | Aktywne matury główne PP i PR oraz poprawkowe PP z 2015-2025, a także główne PP i PR z 2026 r.; czternaście nowo dodanych arkuszy ma źródła, kryteria, rozwiązania, 23 diagramy wektorowe i proweniencję `blocked` do czasu odrębnej zgody na redystrybucję |
