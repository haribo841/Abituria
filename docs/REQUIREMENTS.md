...
| F-08 | System pokazuje matury 2018 PP `34/34/50`, PR `15/15/50` i poprawkową PP `34/34/50`, matury 2019 PP `34/34/50`, PR `15/15/50` i poprawkową PP `34/34/50`, matury 2020 PP `34/34/50`, PR `15/15/50` i poprawkową PP `34/34/50`, matury 2021 PP `35/35/45`, PR `15/15/50` i zachowaną poprawkową PP `35/35/45`, matury 2022 PP `35/35/45`, PR `15/15/50` i poprawkową PP `35/35/45`, matury 2023 PP `31/34/46`, poprawkową PP `33/36/46` i PR `13/14/50`, matury 2024 PP `31/35/46`, poprawkową PP `30/36/46` i PR `13/14/50`, matury 2025 PP `31/35/50`, PR `12/13/50` i poprawkową PP `31/36/50` oraz matury 2026 PP `33/37/50` i PR `12/13/50`. | Wysoki | Zaimplementowane technicznie, publiczna redystrybucja nowych materiałów CKE z grup `blocked` wymaga rozszerzenia deklaracji praw | `Content/exams.json`, `Content/exam-2018-*.json`, `Content/exam-2019-*.json`, `Content/exam-2020-*.json`, `Content/exam-2021-*.json`, `Content/exam-2022-*.json`, `Content/exam-2023-*.json`, `Content/exam-2024-*.json`, `Content/exam-2025-*.json`, `Content/exam-2026-*.json`, testy kontraktowe matur 2018-2026 |
| F-09 | System umożliwia wybór arkusza, losowanie tylko z wybranego arkusza oraz agregację dwudziestu sześciu arkuszy według 17 tematów. | Wysoki | Zaimplementowane | `MaturaView`, `TaskTopicsView`, `ContentRepository`, `Matura2026UiTests` |
...
| F-24 | Profil pokazuje osobno postęp dwudziestu sześciu arkuszy: 2026 PP `x/37`, 2026 PR `x/13`, 2025 PP `x/35`, 2025 PR `x/13`, poprawkowej 2025 PP `x/36`, 2024 PP `x/35`, 2024 PR `x/14`, poprawkowej 2024 PP `x/36`, 2023 PP `x/34`, poprawkowej 2023 PP `x/36`, 2023 PR `x/14`, 2022 PP `x/35`, 2022 PR `x/15`, poprawkowej 2022 PP `x/35`, 2021 PP `x/35`, 2021 PR `x/15`, poprawkowej 2021 `x/35`, 2020 PP `x/34`, 2020 PR `x/15`, poprawkowej 2020 PP `x/34`, 2019 PP `x/34`, 2019 PR `x/15`, poprawkowej 2019 PP `x/34`, 2018 PP `x/34`, 2018 PR `x/15` i poprawkowej 2018 PP `x/34`, a także podstawy `x/219` i części rozszerzonej `x/138`, bez zmiany schematu SQLite. | Wysoki | Zaimplementowane | `ProfileView`, `AccountService`, `Matura2026UiTests`, `MathCourse2023ContentTests` |
