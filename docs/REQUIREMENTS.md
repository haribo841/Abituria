...
23. Testy użyteczności, instalacji niezależnej i decyzja odbiorowa są udokumentowane zgodnie z `USABILITY_TEST_PROTOCOL.md` oraz `ACCEPTANCE_PROTOCOL.md` przed formalnym zakończeniem projektu.
