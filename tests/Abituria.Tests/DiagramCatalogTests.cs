...
public sealed class DiagramCatalogTests
{
    ...
    public void Catalog_contains_exactly_the_required_unique_and_used_primitive_inventory()
    {
        ...
        Assert.Equal(7, catalog.Diagrams.Count(item => item.SourceId == "cke-2017-main-basic-exam"));
        Assert.Equal(3, catalog.Diagrams.Count(item => item.SourceId == "cke-2017-main-extended-exam"));
        Assert.Equal(6, catalog.Diagrams.Count(item => item.SourceId == "cke-2017-correction-basic-exam"));
        Assert.Equal(7, catalog.Diagrams.Count(item => item.SourceId == "cke-2016-main-basic-exam"));
        Assert.Equal(3, catalog.Diagrams.Count(item => item.SourceId == "cke-2016-main-extended-exam"));
        Assert.Equal(5, catalog.Diagrams.Count(item => item.SourceId == "cke-2016-correction-basic-exam"));
        ...
        Assert.Equal(5, catalog.Diagrams.Count(item => item.SourceId == "cke-2023-correction-basic"));
        Assert.Equal(5, catalog.Diagrams.Count(item => item.SourceId == "cke-2024-correction-basic"));
        Assert.Equal(6, catalog.Diagrams.Count(item => item.SourceId == "cke-2025-correction-basic"));
        ...
        Assert.Equal(
            [12, 19, 20, 21, 24, 28],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2025-correction-basic")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [4, 6, 10, 10, 14, 20],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2022-main-basic")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [4, 4, 8, 8, 10, 10, 12, 12],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2021-main-basic")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [2, 8, 20],
        ...
        Assert.Equal(
            [4, 6, 6, 8, 8, 10, 14],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2017-main-basic-exam")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [2, 6, 7],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2017-main-extended-exam")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [4, 6, 8, 8, 10, 12],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2017-correction-basic-exam")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [2, 4, 6, 6, 8, 10, 15],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2016-main-basic-exam")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [2, 8, 20],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2016-main-extended-exam")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [4, 8, 8, 18, 20],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2016-correction-basic-exam")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [18],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2022-main-extended")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [6, 10, 10, 20, 22],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2022-correction-basic")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.All(
        ...
        Assert.Equal(
            [4, 12, 20, 23, 26],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2023-correction-basic")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
            [10, 14, 19, 20, 26],
            catalog.Diagrams.Where(item => item.SourceId == "cke-2024-correction-basic")
                .OrderBy(item => item.Id)
                .Select(item => item.SourcePage));
        Assert.Equal(
