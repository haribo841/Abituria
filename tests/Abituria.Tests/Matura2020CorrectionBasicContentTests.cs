...
public sealed class Matura2020CorrectionBasicContentTests
{
    ...
    [Fact]
    public void Formula_2015_correction_remains_blocked_without_an_explicit_rights_declaration()
    {
        ...
        Assert.Equal("blocked", groups["cke-2020-correction-basic-exam"].GetProperty("distributionStatus").GetString());
