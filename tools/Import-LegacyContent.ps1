...
$placeholders = @(
    ...
    [ordered]@{ id = 'general-calculator'; title = 'Kalkulator ogólny'; category = 'calculator'; message = 'Kalkulator ogólny jest w przygotowaniu.'; roadmapId = 'general-calculator'; blocks = @() }
...
$roadmap = @(
    ...
    [ordered]@{ id = 'general-calculator'; title = 'Kalkulator ogólny'; status = 'planned'; summary = 'Działania podstawowe, nawiasy, potęgowanie i pierwiastkowanie.'; context = 'calculator'; sourceRefs = @('Opis struktury systemu.txt') }
