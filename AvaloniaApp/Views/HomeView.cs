...
{
    public HomeView(string profileName, Action showFormulas, Action showExams, Action showCalculator, Action showChapters)
    {
    ...
    private static void AddTile(Grid grid, int column, int row, string title, string description, string asset, Action action)
    {
